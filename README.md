...
[![Stars](https://img.shields.io/github/stars/nithingowdahm87/argo-actions)](Stars)
![GitHub License](https://img.shields.io/github/license/nithingowdahm87/argo-actions?color=green)
![Dynamic JSON Badge](https://img.shields.io/badge/dynamic/json?url=https%3A%2F%2Fraw.githubusercontent.com%nithingowdahm87%2Fargo-actions%2Frefs%2Fheads%2Fmain%2F.release-please-manifest.json&query=%24%5B%22.%22%5D&label=release)
...
- [Cleanup](https://github.com/nithingowdahm87/argo-actions/blob/main/README.md#step-12-cleanup)
...
![Architecture](https://github.com/aws-containers/argo-actions/raw/main/docs/images/architecture.png)
...
3. **Clone Repository**: `git clone https://github.com/nithingowdahm87/argo-actions.git`
...
```sh
git clone https://github.com/nithingowdahm87/argo-actions.git
```
...
- **Issues**: [GitHub Issues](https://github.com/nithingowdahm87/argo-actions/issues)
