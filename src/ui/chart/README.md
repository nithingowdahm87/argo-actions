...
```bash
helm install ui oci://nithingowdahm87/arco-actions-ui-chart:0.8.5
```

To install with custom values:

```bash
helm install ui oci://nithingowdahm87/arco-actions-ui-chart:0.8.5 --values custom-values.yaml
```
